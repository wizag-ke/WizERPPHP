...
function defaultCompany()
{
	...
	echo '<img class="card-img-top mx-auto mt-2" style="width:90%" src="'.$path_to_root.'/themes/'.$def_theme.'/images/erp.png" alt="Card image cap">';
	...
	echo "<center><input class='btn btn-block login-button' type='submit' value='&nbsp;&nbsp;"._("Sign in")."&nbsp;&nbsp;' name='SubmitUser'"
