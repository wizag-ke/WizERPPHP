...
page(_($help_context = "View Internal Grn"), true);
...
br(1);
$adjustment_items = get_internal_grn_items($trans_no);
$k = 0;
$header_shown = false;
while ($adjustment = db_fetch($adjustment_items))
{
	...
	if (!$header_shown)
	{
		...
		end_row();
		comments_display_row(ST_INTINVGRN, $trans_no);
...
is_voided_display(ST_INTINVGRN, $trans_no, _("This adjustment has been voided."));

end_page(true, false, false, ST_INTINVGRN, $trans_no);
